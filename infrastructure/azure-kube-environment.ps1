...
$kubernetesResourceGroup="cloudnative-rg" # needs to be unique to your subscription
$acrName='hclcloudnativeacr' #must conform to the following pattern: '^[a-zA-Z0-9]*$
$aksClusterName='hclcloudnativeaks'
$location = 'eastus'
